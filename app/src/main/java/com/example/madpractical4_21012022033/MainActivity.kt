package com.example.madpractical4_21012022033
...
class MainActivity : AppCompatActivity() {
    override fun onCreate(savedInstanceState: Bundle?) {
        ...
        btnBrowse.setOnClickListener {
            if(txtBrowse.text.toString()!="")
            {
                Intent(Intent.ACTION_VIEW).setData(
                    Uri.parse("https://"+(txtBrowse.text.toString()))).apply {
                    startActivity(this)
                }
            }
            else{
        ...
        btnCall.setOnClickListener {
            if(txtCall.text.toString()!="")
            {
                Intent(Intent.ACTION_DIAL).setData(
                    Uri.parse("tel:"+txtCall.text.toString())).apply {
                    startActivity(this)
                }
            }
            else{
        ...
        btnContact.setOnClickListener {
            Intent(Intent.ACTION_VIEW).setType(
                ContactsContract.Contacts.CONTENT_TYPE).apply    {
                startActivity(this)
            }
        }
